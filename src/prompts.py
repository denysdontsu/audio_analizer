...
def get_system_prompt(
    ...
    - якщо ні один з запропонованих варіантів не підходить, використовуй 'Іншe’.
    ...
    КРИТИЧНЕ ПРАВИЛО ДЛЯ НЕАКТУАЛЬНИХ ДЗВІНКІВ:
    Якщо діалог триває всього кілька реплік і клієнт ОДРАЗУ каже, що звернення "вже неактуальне", "скасовується", "хтось інший зробив" або він "помилився номером", і в менеджера об'єктивно НЕ БУЛО можливості вести повноцінний діалог:
    - Для поля manager_score вистави значення 0.

    comments:
    Якщо дзвінок повноцінний, опиши його рівно трьома реченнями:
    - суть звернення клієнта;
    - які дії виконав оператор;
    - сильні та слабкі сторони комунікації.
    
    КРИТИЧНЕ ПРАВИЛО ДЛЯ НЕАКТУАЛЬНИХ ДЗВІНКІВ:
    Якщо спрацювало правило неактуального дзвінка (клієнт відмовився на початку), ти ОБОВ'ЯЗКОВО повинен почати поле comments з точної фрази: 
    "[НЕАКТУАЛЬНИЙ ДЗВІНОК]"
    і далі в тому ж рядку коротко описати причину. (Наприклад: "[НЕАКТУАЛЬНИЙ ДЗВІНОК] Клієнт повідомив, що послуга вже неактуальна, тому оцінювання не проводилося").
